...
namespace FlowSpace.Persistence
{
    public static class DbInitializer
    {
        ...
        private static List<User> GetUsers()
        {
            ...
            {
                new User { Id = Guid.Parse("11111111-1111-1111-1111-111111111111"), Name = "Phạm Thanh Dung", Email = "admin@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "director", Avatar = "PD", Color = "#e74c3c", Position = "Giám đốc điều hành", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-3), JoinDate = DateTime.UtcNow.AddYears(-3) },
                new User { Id = Guid.Parse("22222222-2222-2222-2222-222222222222"), Name = "Lê Minh Cường", Email = "truongphong@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "manager", Avatar = "LC", Color = "#e67e22", Position = "Trưởng phòng Kỹ thuật", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-2), JoinDate = DateTime.UtcNow.AddYears(-2) },
                new User { Id = Guid.Parse("33333333-3333-3333-3333-333333333333"), Name = "Trần Thị Bình", Email = "truongnhom@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "team_lead", Avatar = "TB", Color = "#9b59b6", Position = "Trưởng nhóm Phát triển", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-1), JoinDate = DateTime.UtcNow.AddYears(-1) },
                new User { Id = Guid.Parse("44444444-4444-4444-4444-444444444444"), Name = "Nguyễn Văn An", Email = "nhanvien@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "NV", Color = "#2ecc71", Position = "Lập trình viên Fullstack", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-6), JoinDate = DateTime.UtcNow.AddMonths(-6) },
                new User { Id = Guid.Parse("55555555-5555-5555-5555-555555555555"), Name = "Vũ Hoàng Giang", Email = "giang.vu@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "team_lead", Avatar = "VG", Color = "#1abc9c", Position = "Trưởng nhóm Kinh doanh B2B", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-1), JoinDate = DateTime.UtcNow.AddYears(-1) },
                new User { Id = Guid.Parse("66666666-6666-6666-6666-666666666666"), Name = "Đỗ Thùy Trang", Email = "trang.do@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "DT", Color = "#e84393", Position = "Chuyên viên Kinh doanh", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-8), JoinDate = DateTime.UtcNow.AddMonths(-8) },
                new User { Id = Guid.Parse("77777777-7777-7777-7777-777777777777"), Name = "Bùi Anh Tuấn", Email = "tuan.bui@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "BT", Color = "#0984e3", Position = "Kỹ sư Cầu nối (BrSE)", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-5), JoinDate = DateTime.UtcNow.AddMonths(-5) },
                new User { Id = Guid.Parse("88888888-8888-8888-8888-888888888888"), Name = "Phan Minh Trí", Email = "tri.phan@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "PT", Color = "#2d3436", Position = "Lập trình viên Mobile", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-3), JoinDate = DateTime.UtcNow.AddMonths(-3) },
                new User { Id = Guid.Parse("99999999-9999-9999-9999-999999999999"), Name = "Lâm Mỹ Lệ", Email = "le.lam@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "manager", Avatar = "LL", Color = "#fdcb6e", Position = "Trưởng phòng Nhân sự", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-2), JoinDate = DateTime.UtcNow.AddYears(-2) },
                new User { Id = Guid.Parse("aaaaaaaa-aaaa-aaaa-aaaa-aaaaaaaaaaaa"), Name = "Hoàng Kim Yến", Email = "yen.hoang@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "HY", Color = "#fd79a8", Position = "Chuyên viên Tuyển dụng", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-5), JoinDate = DateTime.UtcNow.AddMonths(-5) },
                new User { Id = Guid.Parse("bbbbbbbb-bbbb-bbbb-bbbb-bbbbbbbbbbbb"), Name = "Nguyễn Hữu Nam", Email = "nam.nguyen@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "manager", Avatar = "HN", Color = "#6c5ce7", Position = "Trưởng phòng Marketing", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddYears(-1), JoinDate = DateTime.UtcNow.AddYears(-1) },
                new User { Id = Guid.Parse("cccccccc-cccc-cccc-cccc-cccccccccccc"), Name = "Trần Quang Minh", Email = "minh.tran@flowspace.demo", PasswordHash = defaultPasswordHash, Role = "employee", Avatar = "TM", Color = "#00cec9", Position = "Chuyên viên Sáng tạo nội dung", Active = true, IsEmailVerified = true, EmailVerifiedAt = DateTime.UtcNow.AddMonths(-4), JoinDate = DateTime.UtcNow.AddMonths(-4) }
            };
        }
